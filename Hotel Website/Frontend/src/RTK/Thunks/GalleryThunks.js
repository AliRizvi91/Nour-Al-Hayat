...
export const getAllGallery = createAsyncThunk(
    ...
    async () => {
      try {
        const response = await axios.get('http://localhost:4500/api/ARZ/gallery');
...
export const postGallery = createAsyncThunk(
    ...
    async ({ formData }) => {
      ...
      try {
        ...
        const response = await axios.post('http://localhost:4500/api/ARZ/gallery', formData, {
          headers: {
...
export const DeleteGallery = createAsyncThunk(
    ...
    async ({_id}) => {
      try {
        ...
        // Ensure the request is sent with the correct content-type for form data
        const response = await axios.delete(`http://localhost:4500/api/ARZ/gallery/${_id}`);
      ...
      console.log("formData",formData);
        try {
            ...
            const response = await axios.put(
                `http://localhost:4500/api/ARZ/gallery/${Id}`,formData
            );
